...
def main():
    ...
    best_accuracy = 0.0
    train_writer = SummaryWriter(log_dir='runs/hw1_1a/train')
    validation_writer = SummaryWriter(log_dir='runs/hw1_1a/validation')
    ...
    for epoch in range(num_epochs):
        ...
        #     torch.save(model.state_dict(), f'./checkpoint/hw1_a.pth')
        #     print("The model's weight has been saved.")

        if epoch == 0 or epoch == 49 or epoch == 99:
            torch.save(model.state_dict(), f'./checkpoint/hw1_a_{epoch}.pth')
            print("The model's weight has been saved.")
