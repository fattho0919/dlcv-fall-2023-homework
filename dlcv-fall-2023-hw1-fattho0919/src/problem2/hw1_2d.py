...
def main():
    ...
    best_accuracy = 0.0
    train_writer = SummaryWriter(log_dir='runs/hw1_2d/train')
    validation_writer = SummaryWriter(log_dir='runs/hw1_2d/validation')
    ...
    for epoch in range(num_epochs):
        ...
        if validation_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), f'./checkpoint/hw1_2d.pth')
