...
def main():
    ...
    model.load_state_dict(torch.load('./checkpoint/hw1_ssl_backbone.pth'))
    ...
    best_accuracy = 0.0
    train_writer = SummaryWriter(log_dir='runs/hw1_2c/train')
    validation_writer = SummaryWriter(log_dir='runs/hw1_2c/validation')
    ...
    for epoch in range(num_epochs):
        ...
        if validation_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), f'./checkpoint/hw1_2c.pth')
