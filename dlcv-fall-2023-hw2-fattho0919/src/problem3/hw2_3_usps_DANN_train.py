...
target_train_dataset = dataset_mnist(csv_file_path='./hw2_data/digits/usps/train.csv', data_path='./hw2_data/digits/usps/data', transform=target_img_transform)
...
for ep in range(n_epoch):
    ...
    if acc > best_acc:
        best_acc = acc
        torch.save(dann.state_dict(), './hw2_checkpoint/DANN_usps.pth')
        print(f'best acc = {best_acc:.4f}')
        print('saved model at ' + './hw2_checkpoint/DANN_usps.pth')
    print(f"Best acc: {best_acc:.4f}")
    print("-"*50)
