...
def visualize_tsne(features, labels, save_path):
    ...
    plt.legend(loc='best')
    plt.title('t-SNE of usps DANN Features')
...
visualize_tsne(features, class_labels, './DANN_usps_tsne_class.png')
visualize_tsne(features, domain_labels, './DANN_usps_tsne_domain.png')
