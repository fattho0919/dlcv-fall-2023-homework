...
from original_decoder import Decoder, Decoder_with_adapter, Config
...
output_json_path = "./hw3_2_result_adapter.json"
...
for block in decoder.transformer.h:
    for param in block.adpt.parameters():
...
def train():
    ...
    for epoch in range(epochs):
        ...
        args = Namespace(pred_file="/home/hongfa/DLCV/dlcv-fall-2023-hw3-fattho0919/hw3_2_result_adapter.json", images_root="/home/hongfa/DLCV/dlcv-fall-2023-hw3-fattho0919/hw3_data/p2_data/images/val", annotation_file="/home/hongfa/DLCV/dlcv-fall-2023-hw3-fattho0919/hw3_data/p2_data/val.json")
        ...
        if cider_score > best_score:
            ...
            torch.save(save_weights, checkpoints_path + f"hw3_2_adapter.pth")
...
def validation(load_model=False):
    ...
    if load_model:
        decoder.load_state_dict(torch.load(checkpoints_path + f"hw3_2_adapter.pth"), strict=False)
    decoder.eval()
    with torch.no_grad():
        validation_progress_bar = tqdm(validation_dataloader)
