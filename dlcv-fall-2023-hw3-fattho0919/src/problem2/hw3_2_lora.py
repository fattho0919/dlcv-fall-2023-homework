...
from original_decoder import Decoder_with_lora, Config
...
output_json_path = "./hw3_2_result_lora.json"
...
cfg = Config(cfg_path)
decoder = Decoder_with_lora(cfg)
# freeze the weights of the decoder but lora layer
...
train_dataset = image_caption_pair_dataset(training_image_path, training_caption_json_path, tokenizer, clip_model, clip_processor, train_transform)
train_dataloader = DataLoader(train_dataset, batch_size=1, shuffle=True)
validation_dataset = image_caption_pair_dataset(validation_image_path, validation_caption_json_path, tokenizer, clip_model, clip_processor)
...
def train():
    ...
    for epoch in range(epochs):
        ...
        args = Namespace(pred_file="/home/hongfa/DLCV/dlcv-fall-2023-hw3-fattho0919/hw3_2_result_lora.json", images_root="/home/hongfa/DLCV/dlcv-fall-2023-hw3-fattho0919/hw3_data/p2_data/images/val", annotation_file="/home/hongfa/DLCV/dlcv-fall-2023-hw3-fattho0919/hw3_data/p2_data/val.json")
        ...
        if cider_score > best_score:
            ...
            torch.save(save_weights, checkpoints_path + f"hw3_2_lora.pth")
...
def validation(load_model=False):
    ...
    if load_model:
        decoder.load_state_dict(torch.load(checkpoints_path + f"hw3_2_lora.pth"), strict=False)
    decoder.eval()
    with torch.no_grad():
        validation_progress_bar = tqdm(validation_dataloader)
