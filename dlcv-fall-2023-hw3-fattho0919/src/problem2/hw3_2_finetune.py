...
from original_decoder import Decoder_with_cross_attention, Config
...
cfg = Config(cfg_path)
decoder = Decoder_with_cross_attention(cfg)
...
def train():
    ...
    for epoch in range(epochs):
        ...
        args = Namespace(pred_file="/home/hongfa/DLCV/dlcv-fall-2023-hw3-fattho0919/hw3_2_result.json", images_root="/home/hongfa/DLCV/dlcv-fall-2023-hw3-fattho0919/hw3_data/p2_data/images/val", annotation_file="/home/hongfa/DLCV/dlcv-fall-2023-hw3-fattho0919/hw3_data/p2_data/val.json")
...
def validation(load_model=False):
    ...
    if load_model:
        decoder.load_state_dict(torch.load(checkpoints_path + f"hw3_2.pth"))
    decoder.eval()
    with torch.no_grad():
        validation_progress_bar = tqdm(validation_dataloader)
